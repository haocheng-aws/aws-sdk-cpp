...
namespace Model
{
  ...
  public:
    ...
    ChangeMessageVisibilityBatchResultEntry(Aws::Utils::Json::JsonView jsonValue);
    ChangeMessageVisibilityBatchResultEntry& operator=(Aws::Utils::Json::JsonView jsonValue);
